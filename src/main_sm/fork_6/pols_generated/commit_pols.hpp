...
public:
    ...
    inline Goldilocks::Element & operator[](uint64_t i) { return _pAddress[i*679]; };
...
public:
    ...
    MainCommitPols (void * pAddress, uint64_t degree) :
        A7((Goldilocks::Element *)((uint8_t *)pAddress + 4000), degree, 500),
        A6((Goldilocks::Element *)((uint8_t *)pAddress + 4008), degree, 501),
        A5((Goldilocks::Element *)((uint8_t *)pAddress + 4016), degree, 502),
        A4((Goldilocks::Element *)((uint8_t *)pAddress + 4024), degree, 503),
        A3((Goldilocks::Element *)((uint8_t *)pAddress + 4032), degree, 504),
        A2((Goldilocks::Element *)((uint8_t *)pAddress + 4040), degree, 505),
        A1((Goldilocks::Element *)((uint8_t *)pAddress + 4048), degree, 506),
        A0((Goldilocks::Element *)((uint8_t *)pAddress + 4056), degree, 507),
        B7((Goldilocks::Element *)((uint8_t *)pAddress + 4064), degree, 508),
        B6((Goldilocks::Element *)((uint8_t *)pAddress + 4072), degree, 509),
        B5((Goldilocks::Element *)((uint8_t *)pAddress + 4080), degree, 510),
        B4((Goldilocks::Element *)((uint8_t *)pAddress + 4088), degree, 511),
        B3((Goldilocks::Element *)((uint8_t *)pAddress + 4096), degree, 512),
        B2((Goldilocks::Element *)((uint8_t *)pAddress + 4104), degree, 513),
        B1((Goldilocks::Element *)((uint8_t *)pAddress + 4112), degree, 514),
        B0((Goldilocks::Element *)((uint8_t *)pAddress + 4120), degree, 515),
        C7((Goldilocks::Element *)((uint8_t *)pAddress + 4128), degree, 516),
        C6((Goldilocks::Element *)((uint8_t *)pAddress + 4136), degree, 517),
        C5((Goldilocks::Element *)((uint8_t *)pAddress + 4144), degree, 518),
        C4((Goldilocks::Element *)((uint8_t *)pAddress + 4152), degree, 519),
        C3((Goldilocks::Element *)((uint8_t *)pAddress + 4160), degree, 520),
        C2((Goldilocks::Element *)((uint8_t *)pAddress + 4168), degree, 521),
        C1((Goldilocks::Element *)((uint8_t *)pAddress + 4176), degree, 522),
        C0((Goldilocks::Element *)((uint8_t *)pAddress + 4184), degree, 523),
        D7((Goldilocks::Element *)((uint8_t *)pAddress + 4192), degree, 524),
        D6((Goldilocks::Element *)((uint8_t *)pAddress + 4200), degree, 525),
        D5((Goldilocks::Element *)((uint8_t *)pAddress + 4208), degree, 526),
        D4((Goldilocks::Element *)((uint8_t *)pAddress + 4216), degree, 527),
        D3((Goldilocks::Element *)((uint8_t *)pAddress + 4224), degree, 528),
        D2((Goldilocks::Element *)((uint8_t *)pAddress + 4232), degree, 529),
        D1((Goldilocks::Element *)((uint8_t *)pAddress + 4240), degree, 530),
        D0((Goldilocks::Element *)((uint8_t *)pAddress + 4248), degree, 531),
        E7((Goldilocks::Element *)((uint8_t *)pAddress + 4256), degree, 532),
        E6((Goldilocks::Element *)((uint8_t *)pAddress + 4264), degree, 533),
        E5((Goldilocks::Element *)((uint8_t *)pAddress + 4272), degree, 534),
        E4((Goldilocks::Element *)((uint8_t *)pAddress + 4280), degree, 535),
        E3((Goldilocks::Element *)((uint8_t *)pAddress + 4288), degree, 536),
        E2((Goldilocks::Element *)((uint8_t *)pAddress + 4296), degree, 537),
        E1((Goldilocks::Element *)((uint8_t *)pAddress + 4304), degree, 538),
        E0((Goldilocks::Element *)((uint8_t *)pAddress + 4312), degree, 539),
        SR7((Goldilocks::Element *)((uint8_t *)pAddress + 4320), degree, 540),
        SR6((Goldilocks::Element *)((uint8_t *)pAddress + 4328), degree, 541),
        SR5((Goldilocks::Element *)((uint8_t *)pAddress + 4336), degree, 542),
        SR4((Goldilocks::Element *)((uint8_t *)pAddress + 4344), degree, 543),
        SR3((Goldilocks::Element *)((uint8_t *)pAddress + 4352), degree, 544),
        SR2((Goldilocks::Element *)((uint8_t *)pAddress + 4360), degree, 545),
        SR1((Goldilocks::Element *)((uint8_t *)pAddress + 4368), degree, 546),
        SR0((Goldilocks::Element *)((uint8_t *)pAddress + 4376), degree, 547),
        CTX((Goldilocks::Element *)((uint8_t *)pAddress + 4384), degree, 548),
        SP((Goldilocks::Element *)((uint8_t *)pAddress + 4392), degree, 549),
        PC((Goldilocks::Element *)((uint8_t *)pAddress + 4400), degree, 550),
        GAS((Goldilocks::Element *)((uint8_t *)pAddress + 4408), degree, 551),
        zkPC((Goldilocks::Element *)((uint8_t *)pAddress + 4416), degree, 552),
        RR((Goldilocks::Element *)((uint8_t *)pAddress + 4424), degree, 553),
        HASHPOS((Goldilocks::Element *)((uint8_t *)pAddress + 4432), degree, 554),
        RCX((Goldilocks::Element *)((uint8_t *)pAddress + 4440), degree, 555),
        CONST7((Goldilocks::Element *)((uint8_t *)pAddress + 4448), degree, 556),
        CONST6((Goldilocks::Element *)((uint8_t *)pAddress + 4456), degree, 557),
        CONST5((Goldilocks::Element *)((uint8_t *)pAddress + 4464), degree, 558),
        CONST4((Goldilocks::Element *)((uint8_t *)pAddress + 4472), degree, 559),
        CONST3((Goldilocks::Element *)((uint8_t *)pAddress + 4480), degree, 560),
        CONST2((Goldilocks::Element *)((uint8_t *)pAddress + 4488), degree, 561),
        CONST1((Goldilocks::Element *)((uint8_t *)pAddress + 4496), degree, 562),
        CONST0((Goldilocks::Element *)((uint8_t *)pAddress + 4504), degree, 563),
        FREE7((Goldilocks::Element *)((uint8_t *)pAddress + 4512), degree, 564),
        FREE6((Goldilocks::Element *)((uint8_t *)pAddress + 4520), degree, 565),
        FREE5((Goldilocks::Element *)((uint8_t *)pAddress + 4528), degree, 566),
        FREE4((Goldilocks::Element *)((uint8_t *)pAddress + 4536), degree, 567),
        FREE3((Goldilocks::Element *)((uint8_t *)pAddress + 4544), degree, 568),
        FREE2((Goldilocks::Element *)((uint8_t *)pAddress + 4552), degree, 569),
        FREE1((Goldilocks::Element *)((uint8_t *)pAddress + 4560), degree, 570),
        FREE0((Goldilocks::Element *)((uint8_t *)pAddress + 4568), degree, 571),
        inA((Goldilocks::Element *)((uint8_t *)pAddress + 4576), degree, 572),
        inB((Goldilocks::Element *)((uint8_t *)pAddress + 4584), degree, 573),
        inC((Goldilocks::Element *)((uint8_t *)pAddress + 4592), degree, 574),
        inROTL_C((Goldilocks::Element *)((uint8_t *)pAddress + 4600), degree, 575),
        inD((Goldilocks::Element *)((uint8_t *)pAddress + 4608), degree, 576),
        inE((Goldilocks::Element *)((uint8_t *)pAddress + 4616), degree, 577),
        inSR((Goldilocks::Element *)((uint8_t *)pAddress + 4624), degree, 578),
        inFREE((Goldilocks::Element *)((uint8_t *)pAddress + 4632), degree, 579),
        inFREE0((Goldilocks::Element *)((uint8_t *)pAddress + 4640), degree, 580),
        inCTX((Goldilocks::Element *)((uint8_t *)pAddress + 4648), degree, 581),
        inSP((Goldilocks::Element *)((uint8_t *)pAddress + 4656), degree, 582),
        inPC((Goldilocks::Element *)((uint8_t *)pAddress + 4664), degree, 583),
        inGAS((Goldilocks::Element *)((uint8_t *)pAddress + 4672), degree, 584),
        inSTEP((Goldilocks::Element *)((uint8_t *)pAddress + 4680), degree, 585),
        inRR((Goldilocks::Element *)((uint8_t *)pAddress + 4688), degree, 586),
        inHASHPOS((Goldilocks::Element *)((uint8_t *)pAddress + 4696), degree, 587),
        inRCX((Goldilocks::Element *)((uint8_t *)pAddress + 4704), degree, 588),
        setA((Goldilocks::Element *)((uint8_t *)pAddress + 4712), degree, 589),
        setB((Goldilocks::Element *)((uint8_t *)pAddress + 4720), degree, 590),
        setC((Goldilocks::Element *)((uint8_t *)pAddress + 4728), degree, 591),
        setD((Goldilocks::Element *)((uint8_t *)pAddress + 4736), degree, 592),
        setE((Goldilocks::Element *)((uint8_t *)pAddress + 4744), degree, 593),
        setSR((Goldilocks::Element *)((uint8_t *)pAddress + 4752), degree, 594),
        setCTX((Goldilocks::Element *)((uint8_t *)pAddress + 4760), degree, 595),
        setSP((Goldilocks::Element *)((uint8_t *)pAddress + 4768), degree, 596),
        setPC((Goldilocks::Element *)((uint8_t *)pAddress + 4776), degree, 597),
        setGAS((Goldilocks::Element *)((uint8_t *)pAddress + 4784), degree, 598),
        setRR((Goldilocks::Element *)((uint8_t *)pAddress + 4792), degree, 599),
        setHASHPOS((Goldilocks::Element *)((uint8_t *)pAddress + 4800), degree, 600),
        setRCX((Goldilocks::Element *)((uint8_t *)pAddress + 4808), degree, 601),
        JMP((Goldilocks::Element *)((uint8_t *)pAddress + 4816), degree, 602),
        JMPN((Goldilocks::Element *)((uint8_t *)pAddress + 4824), degree, 603),
        JMPC((Goldilocks::Element *)((uint8_t *)pAddress + 4832), degree, 604),
        JMPZ((Goldilocks::Element *)((uint8_t *)pAddress + 4840), degree, 605),
        offset((Goldilocks::Element *)((uint8_t *)pAddress + 4848), degree, 606),
        incStack((Goldilocks::Element *)((uint8_t *)pAddress + 4856), degree, 607),
        isStack((Goldilocks::Element *)((uint8_t *)pAddress + 4864), degree, 608),
        isMem((Goldilocks::Element *)((uint8_t *)pAddress + 4872), degree, 609),
        ind((Goldilocks::Element *)((uint8_t *)pAddress + 4880), degree, 610),
        indRR((Goldilocks::Element *)((uint8_t *)pAddress + 4888), degree, 611),
        useCTX((Goldilocks::Element *)((uint8_t *)pAddress + 4896), degree, 612),
        carry((Goldilocks::Element *)((uint8_t *)pAddress + 4904), degree, 613),
        mOp((Goldilocks::Element *)((uint8_t *)pAddress + 4912), degree, 614),
        mWR((Goldilocks::Element *)((uint8_t *)pAddress + 4920), degree, 615),
        sWR((Goldilocks::Element *)((uint8_t *)pAddress + 4928), degree, 616),
        sRD((Goldilocks::Element *)((uint8_t *)pAddress + 4936), degree, 617),
        arithEq0((Goldilocks::Element *)((uint8_t *)pAddress + 4944), degree, 618),
        arithEq1((Goldilocks::Element *)((uint8_t *)pAddress + 4952), degree, 619),
        arithEq2((Goldilocks::Element *)((uint8_t *)pAddress + 4960), degree, 620),
        arithEq3((Goldilocks::Element *)((uint8_t *)pAddress + 4968), degree, 621),
        arithEq4((Goldilocks::Element *)((uint8_t *)pAddress + 4976), degree, 622),
        arithEq5((Goldilocks::Element *)((uint8_t *)pAddress + 4984), degree, 623),
        memAlignRD((Goldilocks::Element *)((uint8_t *)pAddress + 4992), degree, 624),
        memAlignWR((Goldilocks::Element *)((uint8_t *)pAddress + 5000), degree, 625),
        memAlignWR8((Goldilocks::Element *)((uint8_t *)pAddress + 5008), degree, 626),
        hashK((Goldilocks::Element *)((uint8_t *)pAddress + 5016), degree, 627),
        hashK1((Goldilocks::Element *)((uint8_t *)pAddress + 5024), degree, 628),
        hashKLen((Goldilocks::Element *)((uint8_t *)pAddress + 5032), degree, 629),
        hashKDigest((Goldilocks::Element *)((uint8_t *)pAddress + 5040), degree, 630),
        hashP((Goldilocks::Element *)((uint8_t *)pAddress + 5048), degree, 631),
        hashP1((Goldilocks::Element *)((uint8_t *)pAddress + 5056), degree, 632),
        hashPLen((Goldilocks::Element *)((uint8_t *)pAddress + 5064), degree, 633),
        hashPDigest((Goldilocks::Element *)((uint8_t *)pAddress + 5072), degree, 634),
        bin((Goldilocks::Element *)((uint8_t *)pAddress + 5080), degree, 635),
        binOpcode((Goldilocks::Element *)((uint8_t *)pAddress + 5088), degree, 636),
        assert_pol((Goldilocks::Element *)((uint8_t *)pAddress + 5096), degree, 637),
        repeat((Goldilocks::Element *)((uint8_t *)pAddress + 5104), degree, 638),
        call((Goldilocks::Element *)((uint8_t *)pAddress + 5112), degree, 639),
        return_pol((Goldilocks::Element *)((uint8_t *)pAddress + 5120), degree, 640),
        isNeg((Goldilocks::Element *)((uint8_t *)pAddress + 5128), degree, 641),
        cntArith((Goldilocks::Element *)((uint8_t *)pAddress + 5136), degree, 642),
        cntBinary((Goldilocks::Element *)((uint8_t *)pAddress + 5144), degree, 643),
        cntMemAlign((Goldilocks::Element *)((uint8_t *)pAddress + 5152), degree, 644),
        cntKeccakF((Goldilocks::Element *)((uint8_t *)pAddress + 5160), degree, 645),
        cntPoseidonG((Goldilocks::Element *)((uint8_t *)pAddress + 5168), degree, 646),
        cntPaddingPG((Goldilocks::Element *)((uint8_t *)pAddress + 5176), degree, 647),
        inCntArith((Goldilocks::Element *)((uint8_t *)pAddress + 5184), degree, 648),
        inCntBinary((Goldilocks::Element *)((uint8_t *)pAddress + 5192), degree, 649),
        inCntMemAlign((Goldilocks::Element *)((uint8_t *)pAddress + 5200), degree, 650),
        inCntKeccakF((Goldilocks::Element *)((uint8_t *)pAddress + 5208), degree, 651),
        inCntPoseidonG((Goldilocks::Element *)((uint8_t *)pAddress + 5216), degree, 652),
        inCntPaddingPG((Goldilocks::Element *)((uint8_t *)pAddress + 5224), degree, 653),
        incCounter((Goldilocks::Element *)((uint8_t *)pAddress + 5232), degree, 654),
        lJmpnCondValue((Goldilocks::Element *)((uint8_t *)pAddress + 5240), degree, 655),
        hJmpnCondValueBit{
        ...
        RCXInv((Goldilocks::Element *)((uint8_t *)pAddress + 5320), degree, 665),
        op0Inv((Goldilocks::Element *)((uint8_t *)pAddress + 5328), degree, 666),
        jmpAddr((Goldilocks::Element *)((uint8_t *)pAddress + 5336), degree, 667),
        elseAddr((Goldilocks::Element *)((uint8_t *)pAddress + 5344), degree, 668),
        useJmpAddr((Goldilocks::Element *)((uint8_t *)pAddress + 5352), degree, 669),
        useElseAddr((Goldilocks::Element *)((uint8_t *)pAddress + 5360), degree, 670),
        sKeyI{
            CommitPol((Goldilocks::Element *)((uint8_t *)pAddress + 5368), degree, 671),
            CommitPol((Goldilocks::Element *)((uint8_t *)pAddress + 5376), degree, 672),
            CommitPol((Goldilocks::Element *)((uint8_t *)pAddress + 5384), degree, 673),
            CommitPol((Goldilocks::Element *)((uint8_t *)pAddress + 5392), degree, 674)
        },
        sKey{
            CommitPol((Goldilocks::Element *)((uint8_t *)pAddress + 5400), degree, 675),
...
public:
    ...
    inline static uint64_t pilSize (void) { return 182267674624; }
    inline static uint64_t pilDegree (void) { return 33554432; }
    inline static uint64_t numPols (void) { return 679; }

    inline void * address (void) { return _pAddress; }
    inline uint64_t degree (void) { return _degree; }
    inline uint64_t size (void) { return _degree*679*sizeof(Goldilocks::Element); }
...
inline const char * address2CommitPolName (uint64_t address)
{
    ...
    if ((address >= 4000) && (address <= 4007)) return "Main.A7";
    if ((address >= 4008) && (address <= 4015)) return "Main.A6";
    if ((address >= 4016) && (address <= 4023)) return "Main.A5";
    if ((address >= 4024) && (address <= 4031)) return "Main.A4";
    if ((address >= 4032) && (address <= 4039)) return "Main.A3";
    if ((address >= 4040) && (address <= 4047)) return "Main.A2";
    if ((address >= 4048) && (address <= 4055)) return "Main.A1";
    if ((address >= 4056) && (address <= 4063)) return "Main.A0";
    if ((address >= 4064) && (address <= 4071)) return "Main.B7";
    if ((address >= 4072) && (address <= 4079)) return "Main.B6";
    if ((address >= 4080) && (address <= 4087)) return "Main.B5";
    if ((address >= 4088) && (address <= 4095)) return "Main.B4";
    if ((address >= 4096) && (address <= 4103)) return "Main.B3";
    if ((address >= 4104) && (address <= 4111)) return "Main.B2";
    if ((address >= 4112) && (address <= 4119)) return "Main.B1";
    if ((address >= 4120) && (address <= 4127)) return "Main.B0";
    if ((address >= 4128) && (address <= 4135)) return "Main.C7";
    if ((address >= 4136) && (address <= 4143)) return "Main.C6";
    if ((address >= 4144) && (address <= 4151)) return "Main.C5";
    if ((address >= 4152) && (address <= 4159)) return "Main.C4";
    if ((address >= 4160) && (address <= 4167)) return "Main.C3";
    if ((address >= 4168) && (address <= 4175)) return "Main.C2";
    if ((address >= 4176) && (address <= 4183)) return "Main.C1";
    if ((address >= 4184) && (address <= 4191)) return "Main.C0";
    if ((address >= 4192) && (address <= 4199)) return "Main.D7";
    if ((address >= 4200) && (address <= 4207)) return "Main.D6";
    if ((address >= 4208) && (address <= 4215)) return "Main.D5";
    if ((address >= 4216) && (address <= 4223)) return "Main.D4";
    if ((address >= 4224) && (address <= 4231)) return "Main.D3";
    if ((address >= 4232) && (address <= 4239)) return "Main.D2";
    if ((address >= 4240) && (address <= 4247)) return "Main.D1";
    if ((address >= 4248) && (address <= 4255)) return "Main.D0";
    if ((address >= 4256) && (address <= 4263)) return "Main.E7";
    if ((address >= 4264) && (address <= 4271)) return "Main.E6";
    if ((address >= 4272) && (address <= 4279)) return "Main.E5";
    if ((address >= 4280) && (address <= 4287)) return "Main.E4";
    if ((address >= 4288) && (address <= 4295)) return "Main.E3";
    if ((address >= 4296) && (address <= 4303)) return "Main.E2";
    if ((address >= 4304) && (address <= 4311)) return "Main.E1";
    if ((address >= 4312) && (address <= 4319)) return "Main.E0";
    if ((address >= 4320) && (address <= 4327)) return "Main.SR7";
    if ((address >= 4328) && (address <= 4335)) return "Main.SR6";
    if ((address >= 4336) && (address <= 4343)) return "Main.SR5";
    if ((address >= 4344) && (address <= 4351)) return "Main.SR4";
    if ((address >= 4352) && (address <= 4359)) return "Main.SR3";
    if ((address >= 4360) && (address <= 4367)) return "Main.SR2";
    if ((address >= 4368) && (address <= 4375)) return "Main.SR1";
    if ((address >= 4376) && (address <= 4383)) return "Main.SR0";
    if ((address >= 4384) && (address <= 4391)) return "Main.CTX";
    if ((address >= 4392) && (address <= 4399)) return "Main.SP";
    if ((address >= 4400) && (address <= 4407)) return "Main.PC";
    if ((address >= 4408) && (address <= 4415)) return "Main.GAS";
    if ((address >= 4416) && (address <= 4423)) return "Main.zkPC";
    if ((address >= 4424) && (address <= 4431)) return "Main.RR";
    if ((address >= 4432) && (address <= 4439)) return "Main.HASHPOS";
    if ((address >= 4440) && (address <= 4447)) return "Main.RCX";
    if ((address >= 4448) && (address <= 4455)) return "Main.CONST7";
    if ((address >= 4456) && (address <= 4463)) return "Main.CONST6";
    if ((address >= 4464) && (address <= 4471)) return "Main.CONST5";
    if ((address >= 4472) && (address <= 4479)) return "Main.CONST4";
    if ((address >= 4480) && (address <= 4487)) return "Main.CONST3";
    if ((address >= 4488) && (address <= 4495)) return "Main.CONST2";
    if ((address >= 4496) && (address <= 4503)) return "Main.CONST1";
    if ((address >= 4504) && (address <= 4511)) return "Main.CONST0";
    if ((address >= 4512) && (address <= 4519)) return "Main.FREE7";
    if ((address >= 4520) && (address <= 4527)) return "Main.FREE6";
    if ((address >= 4528) && (address <= 4535)) return "Main.FREE5";
    if ((address >= 4536) && (address <= 4543)) return "Main.FREE4";
    if ((address >= 4544) && (address <= 4551)) return "Main.FREE3";
    if ((address >= 4552) && (address <= 4559)) return "Main.FREE2";
    if ((address >= 4560) && (address <= 4567)) return "Main.FREE1";
    if ((address >= 4568) && (address <= 4575)) return "Main.FREE0";
    if ((address >= 4576) && (address <= 4583)) return "Main.inA";
    if ((address >= 4584) && (address <= 4591)) return "Main.inB";
    if ((address >= 4592) && (address <= 4599)) return "Main.inC";
    if ((address >= 4600) && (address <= 4607)) return "Main.inROTL_C";
    if ((address >= 4608) && (address <= 4615)) return "Main.inD";
    if ((address >= 4616) && (address <= 4623)) return "Main.inE";
    if ((address >= 4624) && (address <= 4631)) return "Main.inSR";
    if ((address >= 4632) && (address <= 4639)) return "Main.inFREE";
    if ((address >= 4640) && (address <= 4647)) return "Main.inFREE0";
    if ((address >= 4648) && (address <= 4655)) return "Main.inCTX";
    if ((address >= 4656) && (address <= 4663)) return "Main.inSP";
    if ((address >= 4664) && (address <= 4671)) return "Main.inPC";
    if ((address >= 4672) && (address <= 4679)) return "Main.inGAS";
    if ((address >= 4680) && (address <= 4687)) return "Main.inSTEP";
    if ((address >= 4688) && (address <= 4695)) return "Main.inRR";
    if ((address >= 4696) && (address <= 4703)) return "Main.inHASHPOS";
    if ((address >= 4704) && (address <= 4711)) return "Main.inRCX";
    if ((address >= 4712) && (address <= 4719)) return "Main.setA";
    if ((address >= 4720) && (address <= 4727)) return "Main.setB";
    if ((address >= 4728) && (address <= 4735)) return "Main.setC";
    if ((address >= 4736) && (address <= 4743)) return "Main.setD";
    if ((address >= 4744) && (address <= 4751)) return "Main.setE";
    if ((address >= 4752) && (address <= 4759)) return "Main.setSR";
    if ((address >= 4760) && (address <= 4767)) return "Main.setCTX";
    if ((address >= 4768) && (address <= 4775)) return "Main.setSP";
    if ((address >= 4776) && (address <= 4783)) return "Main.setPC";
    if ((address >= 4784) && (address <= 4791)) return "Main.setGAS";
    if ((address >= 4792) && (address <= 4799)) return "Main.setRR";
    if ((address >= 4800) && (address <= 4807)) return "Main.setHASHPOS";
    if ((address >= 4808) && (address <= 4815)) return "Main.setRCX";
    if ((address >= 4816) && (address <= 4823)) return "Main.JMP";
    if ((address >= 4824) && (address <= 4831)) return "Main.JMPN";
    if ((address >= 4832) && (address <= 4839)) return "Main.JMPC";
    if ((address >= 4840) && (address <= 4847)) return "Main.JMPZ";
    if ((address >= 4848) && (address <= 4855)) return "Main.offset";
    if ((address >= 4856) && (address <= 4863)) return "Main.incStack";
    if ((address >= 4864) && (address <= 4871)) return "Main.isStack";
    if ((address >= 4872) && (address <= 4879)) return "Main.isMem";
    if ((address >= 4880) && (address <= 4887)) return "Main.ind";
    if ((address >= 4888) && (address <= 4895)) return "Main.indRR";
    if ((address >= 4896) && (address <= 4903)) return "Main.useCTX";
    if ((address >= 4904) && (address <= 4911)) return "Main.carry";
    if ((address >= 4912) && (address <= 4919)) return "Main.mOp";
    if ((address >= 4920) && (address <= 4927)) return "Main.mWR";
    if ((address >= 4928) && (address <= 4935)) return "Main.sWR";
    if ((address >= 4936) && (address <= 4943)) return "Main.sRD";
    if ((address >= 4944) && (address <= 4951)) return "Main.arithEq0";
    if ((address >= 4952) && (address <= 4959)) return "Main.arithEq1";
    if ((address >= 4960) && (address <= 4967)) return "Main.arithEq2";
    if ((address >= 4968) && (address <= 4975)) return "Main.arithEq3";
    if ((address >= 4976) && (address <= 4983)) return "Main.arithEq4";
    if ((address >= 4984) && (address <= 4991)) return "Main.arithEq5";
    if ((address >= 4992) && (address <= 4999)) return "Main.memAlignRD";
    if ((address >= 5000) && (address <= 5007)) return "Main.memAlignWR";
    if ((address >= 5008) && (address <= 5015)) return "Main.memAlignWR8";
    if ((address >= 5016) && (address <= 5023)) return "Main.hashK";
    if ((address >= 5024) && (address <= 5031)) return "Main.hashK1";
    if ((address >= 5032) && (address <= 5039)) return "Main.hashKLen";
    if ((address >= 5040) && (address <= 5047)) return "Main.hashKDigest";
    if ((address >= 5048) && (address <= 5055)) return "Main.hashP";
    if ((address >= 5056) && (address <= 5063)) return "Main.hashP1";
    if ((address >= 5064) && (address <= 5071)) return "Main.hashPLen";
    if ((address >= 5072) && (address <= 5079)) return "Main.hashPDigest";
    if ((address >= 5080) && (address <= 5087)) return "Main.bin";
    if ((address >= 5088) && (address <= 5095)) return "Main.binOpcode";
    if ((address >= 5096) && (address <= 5103)) return "Main.assert_pol";
    if ((address >= 5104) && (address <= 5111)) return "Main.repeat";
    if ((address >= 5112) && (address <= 5119)) return "Main.call";
    if ((address >= 5120) && (address <= 5127)) return "Main.return_pol";
    if ((address >= 5128) && (address <= 5135)) return "Main.isNeg";
    if ((address >= 5136) && (address <= 5143)) return "Main.cntArith";
    if ((address >= 5144) && (address <= 5151)) return "Main.cntBinary";
    if ((address >= 5152) && (address <= 5159)) return "Main.cntMemAlign";
    if ((address >= 5160) && (address <= 5167)) return "Main.cntKeccakF";
    if ((address >= 5168) && (address <= 5175)) return "Main.cntPoseidonG";
    if ((address >= 5176) && (address <= 5183)) return "Main.cntPaddingPG";
    if ((address >= 5184) && (address <= 5191)) return "Main.inCntArith";
    if ((address >= 5192) && (address <= 5199)) return "Main.inCntBinary";
    if ((address >= 5200) && (address <= 5207)) return "Main.inCntMemAlign";
    if ((address >= 5208) && (address <= 5215)) return "Main.inCntKeccakF";
    if ((address >= 5216) && (address <= 5223)) return "Main.inCntPoseidonG";
    if ((address >= 5224) && (address <= 5231)) return "Main.inCntPaddingPG";
    if ((address >= 5232) && (address <= 5239)) return "Main.incCounter";
    if ((address >= 5240) && (address <= 5247)) return "Main.lJmpnCondValue";
    if ((address >= 5248) && (address <= 5255)) return "Main.hJmpnCondValueBit[0]";
    if ((address >= 5256) && (address <= 5263)) return "Main.hJmpnCondValueBit[1]";
    if ((address >= 5264) && (address <= 5271)) return "Main.hJmpnCondValueBit[2]";
    if ((address >= 5272) && (address <= 5279)) return "Main.hJmpnCondValueBit[3]";
    if ((address >= 5280) && (address <= 5287)) return "Main.hJmpnCondValueBit[4]";
    if ((address >= 5288) && (address <= 5295)) return "Main.hJmpnCondValueBit[5]";
    if ((address >= 5296) && (address <= 5303)) return "Main.hJmpnCondValueBit[6]";
    if ((address >= 5304) && (address <= 5311)) return "Main.hJmpnCondValueBit[7]";
    if ((address >= 5312) && (address <= 5319)) return "Main.hJmpnCondValueBit[8]";
    if ((address >= 5320) && (address <= 5327)) return "Main.RCXInv";
    if ((address >= 5328) && (address <= 5335)) return "Main.op0Inv";
    if ((address >= 5336) && (address <= 5343)) return "Main.jmpAddr";
    if ((address >= 5344) && (address <= 5351)) return "Main.elseAddr";
    if ((address >= 5352) && (address <= 5359)) return "Main.useJmpAddr";
    if ((address >= 5360) && (address <= 5367)) return "Main.useElseAddr";
    if ((address >= 5368) && (address <= 5375)) return "Main.sKeyI[0]";
    if ((address >= 5376) && (address <= 5383)) return "Main.sKeyI[1]";
    if ((address >= 5384) && (address <= 5391)) return "Main.sKeyI[2]";
    if ((address >= 5392) && (address <= 5399)) return "Main.sKeyI[3]";
    if ((address >= 5400) && (address <= 5407)) return "Main.sKey[0]";
    if ((address >= 5408) && (address <= 5415)) return "Main.sKey[1]";
    if ((address >= 5416) && (address <= 5423)) return "Main.sKey[2]";
    if ((address >= 5424) && (address <= 5431)) return "Main.sKey[3]";
